...
if __name__ == "__main__":
    ...
    train.to_csv(
        "src/features/propernouns_verbs_sent_len/train_pn_verb_counts.csv.gz",
        compression="gzip",
        index=False,
    )

    test.to_csv(
        "src/features/propernouns_verbs_sent_len/test_pn_verb_counts.csv.gz",
        compression="gzip",
        index=False,
    )

    val.to_csv(
        "src/features/propernouns_verbs_sent_len/val_pn_verb_counts.csv.gz",
        compression="gzip",
        index=False,
    )
